              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                ...
                {!showForm ? (
                  <button
                    ...
                    className="inline-flex h-10 items-center gap-2 rounded-2xl bg-[#FF4800] px-5 text-sm font-semibold text-white shadow-[0_10px_20px_rgba(255, 72, 0,0.25)] hover:bg-[#D43B00]"
                  >
