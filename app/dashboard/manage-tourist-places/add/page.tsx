...
export default function AddTouristPlacePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 7.5. Insert configured activities
      ...
      if (enabledActivities.length > 0) {
        const activitiesPayload = enabledActivities.map(act => ({
          ...
          child_age_min: act.child_age_min ? parseInt(act.child_age_min, 10) : null,
          child_age_max: act.child_age_max ? parseInt(act.child_age_max, 10) : null,
