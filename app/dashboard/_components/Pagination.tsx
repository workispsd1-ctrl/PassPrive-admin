...
export default function PaginationBar({
  ...
  return (
    <div className="w-full flex justify-end px-4 py-2 bg-transparent text-sm text-gray-700">
      <div className="flex items-center space-x-4">
        ...
        {/* Current Page Number */}
        <div className="w-8 h-8 flex items-center justify-center rounded bg-[#FF4800] text-white font-semibold">
          {page || 1}
        </div>
  ...
  className="cursor-pointer text-[#FF4800] font-semibold bg-transparent focus:outline-none"
>
