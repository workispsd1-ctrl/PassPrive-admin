    ...
    <div className="flex flex-col sm:flex-row gap-3 items-center">
      <div className="flex-1 relative w-full">
        ...
        <Input
          ...
          className="pl-[48px] pr-[16px] h-[44px] rounded-[12px] border border-gray-200 bg-[#FFFFFF] text-[14px] font-normal placeholder:!text-[#938F96] !shadow-[0px_2px_8px_0px_rgba(31,38,135,0.08)] focus-visible:ring-0 focus-visible:ring-offset-0"
